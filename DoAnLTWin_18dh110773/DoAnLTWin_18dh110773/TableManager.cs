...
using DoAnLTWin_18dh110773DAO;
using QDoAnLTWin_18dh110773.DAO;
...
namespace DoAnLTWin_18dh110773
{
    public partial class TableManager : Form
    {
        ...
        */
        ...
        {
            lsvBill.Items.Clear();
            List<DoAnLTWin_18dh110773.DTO.Menu> listBillInfo = MenuDAO.Instance.GetListMenuByTable(id);
            float totalPrice = 0;
            foreach (DoAnLTWin_18dh110773.DTO.Menu item in listBillInfo)
            {
        ...
        {
            Adminstrator f = new Adminstrator();
